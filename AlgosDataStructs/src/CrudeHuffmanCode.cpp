...
//    int freq[] = {895,121,188,953,378,849,153,579,144,727,589,301,442,327,930};
//    int size = sizeof(arr)/sizeof(arr[0]);
//    std::qsort(freq, size, sizeof *freq, [](const void* a, const void* b)
//    {
...
//    });
    ...
    std::cout << "Min : " << *code_length.begin() << ", Max : " << *code_length.rbegin();
    return 0;
}
