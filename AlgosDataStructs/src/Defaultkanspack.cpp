...
int main(){
    ...
    int knapSackSize;
    int nItems;
    ifs >> knapSackSize >> nItems;
    std::cout << knapSackSize << "," << nItems;
    ...
    for(int i = 0 ; i < nItems ; ++i){
        ...
        ifs >> itemValue >> itemSize;

        valuesAndSizes.push_back(make_pair( itemValue , itemSize ) );
    }
